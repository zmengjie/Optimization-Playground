...
# --- Optimizer Config ---
    st.markdown("""
    <div style='background-color: #e3e8ec; padding: 25px 30px; border-radius: 12px; margin-bottom: 25px;'>
    ...
    # --- Auto-Tune & Animation ---
    st.markdown("""
    <div style='background-color: #eee8e1; padding: 25px 30px; border-radius: 12px; margin-bottom: 25px;'>
    ...
    # --- Symbolic Tab ---
    st.markdown("""
    <div style='background-color: #e9eff1; padding: 25px 30px; border-radius: 12px; margin-bottom: 20px;'>
...
with tab2:
    ...
    if mode_dim == "Bivariate (f(x,y))":
        ...
        fig_uni, ax_uni = plt.subplots(figsize=(6, 3))
